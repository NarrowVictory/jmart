...
class Laporan extends CI_Controller
{
    ...
    public function penjualan_periode_excel()
    {
        ...
        $spreadsheet->getActiveSheet()->setCellValue('E2', 'Jenis Order');
        $spreadsheet->getActiveSheet()->setCellValue('F2', 'Metode Bayar');
        $spreadsheet->getActiveSheet()->setCellValue('G2', 'Ongkos Kirim');
        $spreadsheet->getActiveSheet()->setCellValue('H2', 'Total Penjualan');
        $spreadsheet->getActiveSheet()->setCellValue('I2', 'Status Pesanan');
        $spreadsheet->getActiveSheet()->setCellValue('J2', 'Status Pembayaran');

        // Menerapkan border pada header
        $spreadsheet->getActiveSheet()->getStyle('A2:J2')->getBorders()->getAllBorders()->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
        ...
        foreach ($pesanan as $key => $item) {
            ...
            $spreadsheet->getActiveSheet()->setCellValue('D' . $row, $item['nama_member']);
            $spreadsheet->getActiveSheet()->setCellValue('E' . $row, ucwords(str_replace('_', ' ', $item['jenis_order'])));
            $spreadsheet->getActiveSheet()->setCellValue('F' . $row, ucwords(str_replace('_', ' ', $item['metode_bayar'])));
            $spreadsheet->getActiveSheet()->setCellValue('G' . $row, $item['ongkos_kirim']);
            $spreadsheet->getActiveSheet()->setCellValue('H' . $row, $item['grand_total']);
            $spreadsheet->getActiveSheet()->setCellValue('I' . $row, $item['status_pesanan']);
            $spreadsheet->getActiveSheet()->setCellValue('J' . $row, $item['status_pembayaran']);
        ...
        $spreadsheet->getActiveSheet()->setCellValue('G' . $row, 'Total Biaya Pembelian');
        $spreadsheet->getActiveSheet()->setCellValue('H' . $row, $totalBiayaPembelian);

        // Tambahkan border pada sel total biaya pembelian
        $spreadsheet->getActiveSheet()->getStyle('G' . $row . ':H' . $row)->getBorders()->getAllBorders()->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
    ...
    public function penjualan_barang_excel()
    {
        ...
        $spreadsheet->getActiveSheet()->setCellValue('G' . $row, 'Total Penjualan');
        $spreadsheet->getActiveSheet()->setCellValue('H' . $row, $total_harga_semua);
    ...
    public function penjualan_kasir_excel()
    {
        ...
        $spreadsheet->getActiveSheet()->setCellValue('C2', 'Tanggal');
        $spreadsheet->getActiveSheet()->setCellValue('D2', 'Customer');
        $spreadsheet->getActiveSheet()->setCellValue('E2', 'Nama Barang');
        $spreadsheet->getActiveSheet()->setCellValue('F2', 'Barcode');
        $spreadsheet->getActiveSheet()->setCellValue('G2', 'QTY');
        ...
        foreach ($pesanan as $key => $value) {
            ...
            $spreadsheet->getActiveSheet()->setCellValue('B' . $row, $value['id_pesanan']);
            $spreadsheet->getActiveSheet()->setCellValue('C' . $row, date('d/M/Y', strtotime($value['tgl_pesanan'])));
            $spreadsheet->getActiveSheet()->setCellValue('D' . $row, $value['nama_member']);
            $spreadsheet->getActiveSheet()->setCellValue('E' . $row, $value['nama_barang']);
            $spreadsheet->getActiveSheet()->setCellValue('F' . $row, $value['barcode']);
            $spreadsheet->getActiveSheet()->setCellValue('G' . $row, $value['jumlah_jual']);
        ...
        $spreadsheet->getActiveSheet()->setCellValue('H' . $row, 'Total Biaya Penjualan');
        $spreadsheet->getActiveSheet()->getStyle('H' . $row)->getFont()->setBold(true);
        $spreadsheet->getActiveSheet()->setCellValue('I' . $row, 'Rp. ' . number_format($total_harga_semua));
