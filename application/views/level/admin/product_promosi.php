                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td colspan="1" class="text-center align-middle">
                                        ...
                                        <input required name="hargaPromo[]" type="number" min="1" class="form-control" placeholder="Set Harga Promo (Dalam Rp.)">
                                    </td>
                                    <td colspan="1" class="text-center align-middle">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td colspan="1" class="text-center align-middle">
                                        ...
                                        <input value="${item.harga_promo}" required name="hargaPromoEdit[]" type="number" min="1" class="form-control" placeholder="Set Harga Promo (Dalam Rp.)">
                                    </td>
                                    <td colspan="1" class="text-center align-middle">
