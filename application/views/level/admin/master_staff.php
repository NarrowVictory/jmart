                    ...
                    <div class="card-body">
                        <form id="form-simpan" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <input required type="text" class="form-control" placeholder="Username" id="username_kasir">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label required">Password</label>
                                <div>
                                    <input required type="password" class="form-control" placeholder="Password" id="password_kasir">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
