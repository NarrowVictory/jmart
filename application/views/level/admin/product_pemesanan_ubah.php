                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status_pemesanan" id="status_pemesanan" class="form-select">
                            ...
                            <option value="Received" <?= $pemesanan['status_pemesanan'] == "Received" ? "selected" : "" ?>>Diterima</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="tgl_diterima" class="form-label">Tanggal Diterima</label>
                        <input type="datetime-local" class="form-control" id="tgl_diterima" name="tgl_diterima">
                    </div>
                    <div class="mb-3">
