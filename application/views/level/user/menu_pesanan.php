...
<section class="mt-4 mb-4">
    <div class="container">
        <div class="card">
            <div class="border-bottom content fw-bold d-flex justify-content-between">
                <div>
        ...
        <div class="row mt-3">
            <div class="col-6">
                <div class="card ps-3 text-uppercase pt-4">
                    ...
                    <p style="font-size: 20px;font-weight: bold;" class="text-danger text-capitalize font-11 opacity-70 mb-2"> Rp. 0,000</p>
                </div>
            </div>
            <div class="col-6">
                <div class="card ps-3 text-uppercase pt-4">
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <div class="tagihan-card">
                        <h5 class="tagihan-title">Tagihan Autodebit Anda</h5>
                        <p class="tagihan-info">Jatuh Tempo: 31 September 2023</p>
                        <p style="font-size: 20px;font-weight: bold;" class="text-danger opacity-70">Rp. 0,000</p>
                    </div>
                </div>
            </div>
        </div>
