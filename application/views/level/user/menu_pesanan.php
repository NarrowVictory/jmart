        ...
        <div class="row mt-3">
            <div class="col-6 d-flex">
                <div class="card ps-3 text-uppercase pt-4 w-100">
                    <!-- <h3 class="text-dark fa-3x"><?= $count_bulan_ini ?></h3> -->
                    <h5 class="text-dark mb-0">Autodebit Bulan Ini</h5>
                    <small class="pb-3">
                        <?php
                        $tanggal_mulai = date('d/m/Y', strtotime(date('Y-m-16', strtotime('last month'))));
                        $tanggal_selesai = date('d/m/Y', strtotime(date('Y-m-15')));
                        echo $tanggal_mulai . ' - ' . $tanggal_selesai;
                        ?>
                    </small>
                    <p style="font-size: 20px;font-weight: bold;" class="text-danger text-capitalize font-11 opacity-70 mb-2"> Rp. <?= number_format($autodebit_bulan_ini) ?></p>
                </div>
            </div>
            <div class="col-6 d-flex">
                <div class="card ps-3 text-uppercase pt-4 w-100">
