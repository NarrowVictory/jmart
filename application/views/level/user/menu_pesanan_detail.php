		...
		<div class="card" style="box-shadow: none !important;border-radius: 0px !important;">
							...
							foreach ($pesanan as $key => $value) : ?>
								...
								<tr>
									...
									<td class="text-orange text-end fw-bold">
										<?= "Rp. " . number_format($value['harga_saat_ini'] *  $value['jumlah_jual']) ?>
									</td>
								</tr>
							<?php endforeach ?>
						</tbody>
					...
					<div class="d-flex justify-content-end align-items-center m-3 mb-2 p-1">
						<div class="order-calculations">
							<div class="d-flex justify-content-between mb-2">
								...
								<span class="text-heading">Rp. <?= number_format($detail['grand_total'] - $detail['ongkos_kirim']) ?></span>
							</div>
							<div class="d-flex justify-content-between mb-2">
			...
			<div class="card-footer border-top">
				<div class="justify-content-between text-center d-flex">
					...
					<a href="javascript::void" class="text-end text-danger fw-bold float-end">
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(2550, 0, 0, 1);">
