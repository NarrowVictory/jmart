    ...
    <div class="container details-page">
        ...
        <div class="product-details" style="border-top: 2px dashed #ebebeb;">
            <div class="product-name">
                ...
                <h6 style="font-size: 12px;line-height: 1.2;margin-bottom: 0;">20% OFF</h6>
            </div>
            <div class="ratings mt-1">
                <div class="d-flex align-items-center gap-1">
                    <h4 style="font-size: 14px;margin-bottom: 0;" class="theme-color fw-normal">4.0</h4>

                    <ul class="rating-stars" style="padding: 0;margin-bottom: 0;">
                        <li><img class="img-fluid stars" src="https://themes.pixelstrap.com/fuzzy/assets/images/svg/Star.svg" alt="star"></li>
                        <li><img class="img-fluid stars" src="https://themes.pixelstrap.com/fuzzy/assets/images/svg/Star.svg" alt="star"></li>
                        <li><img class="img-fluid stars" src="https://themes.pixelstrap.com/fuzzy/assets/images/svg/Star.svg" alt="star"></li>
                        <li><img class="img-fluid stars" src="https://themes.pixelstrap.com/fuzzy/assets/images/svg/Star.svg" alt="star"></li>
                        <li><img class="img-fluid stars" src="https://themes.pixelstrap.com/fuzzy/assets/images/svg/star1.svg" alt="star"></li>
                    </ul>
                    <h4 style="font-size: 14px;margin-bottom: 0;" class="reviews">156 Reviews</h4>
                </div>
            </div>
            <div class="product-price">
                <h3 style="margin-bottom: 0;">Rp. <?= number_format($barang['harga_promo']) ?> <del style="text-align: right;color:red"><?= number_format($barang['harga_jual_barang']) ?></del></h3>
            </div>
        </div>
