   ...
   <div class="container">
      <div class="card" style="background-image: url('public/template/img/illustrations/path-card.svg');background-position: bottom right;background-repeat: no-repeat;">
         <div class="card-header">
            <img style="width: 5.6rem;height: 5.6rem;" src="https://sedekahonline.com/cc-content/themes/cicool-so/asset/uploads/user/default.png" class="avatar avatar--large profile-kad__avatar shadow" onerror="this.src='https://sedekahonline.com/cc-content/themes/cicool-so/asset/uploads/user/default.png'">
            <a href="<?= base_url('akun/edit') ?>" class="btn btn-primary float-end">Edit Profil</a>
         </div>
         <div class="card-body">
            <span class="text-primary fw-bold">Muhammad Rifki Kardawi</span>
            <p class="">Bergabung pada : <?= date('d/m/Y H:i:s') ?></p>
         </div>
      </div>
      <div class="card mt-3" style="position: relative;">
            ...
            <span class="dblock fsize-m-2 mar-bottom--x-half mar-top--x-half">
               Desa Kumbang Punteut (Dekat Puskesmas), BLANG MANGAT, KOTA LHOKSEUMAWE, NANGGROE ACEH DARUSSALAM (NAD), ID | 24375
            </span>
            </div>
        </div>
   </div>
